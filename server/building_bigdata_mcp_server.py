...
@mcp.tool()
def office_address_details(matchKeyword: str, address: str = None, pageIndex: int = None, keywordType: str = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def office_address_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def building_query(matchKeyword: str = None, pageIndex: int = None, address: str = None, pageSize: int = None, estatePropertyType: str = None) -> dict:
    """
...
if __name__ == "__main__":
    print("正在启动building_bigdata MCP服务器...")
