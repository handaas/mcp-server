...
@mcp.tool()
def exhibition_participation(matchKeyword: str, pageIndex: int = None, pageSize: int = None, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def exhibition_venue_search(pavilionRegion: str, matchKeyword: str = None, pageIndex: int = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def exhibition_search(matchKeyword: str = None, pageIndex: int = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def exhibitor_search(fairRegion: str = None, matchKeyword: str = None, fairIndustries: str = None, fairBeginTimes: str = None, fairEndTimes: str = None, pageIndex: int = None, fairCount: str = None, pageSize: int = None) -> dict:
    """
...
if __name__ == "__main__":
    print("正在启动exhibition_bigdata MCP服务器...")
