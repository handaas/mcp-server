...
@mcp.tool()
def serious_violations(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def chattel_mortgage(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def court_hearings(matchKeyword: str, pageIndex: int = None, pageSize: int = None, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def litigation_risk_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def court_announcements(matchKeyword: str, pageIndex: int = None, pageSize: int = None, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def intellectual_property_pledge(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def tax_penalties(matchKeyword: str, pageIndex: int = None, keywordType: str = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def business_anomalies(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def consumption_restrictions(matchKeyword: str, pageIndex: int = None, keywordType: str = None, pageSize: int = None) -> dict:
    """
