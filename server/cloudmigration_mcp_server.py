...
@mcp.tool()
def cloud_assets(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def domain_info(matchKeyword: str, pageIndex: int = None, keywordType: str = None, pageSize: int = None) -> dict:
    """
...
if __name__ == "__main__":
    print("正在启动cloudmigration MCP服务器...")
