...
@mcp.tool()
def patent_search(matchKeyword: str, pageSize: int = None, patentType: str = None, keywordType: str = None, pageIndex: int = None) -> dict:
    """
...
@mcp.tool()
def patent_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
if __name__ == "__main__":
    print("正在启动patent_bigdata MCP服务器...")
