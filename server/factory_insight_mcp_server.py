...
@mcp.tool()
def factory_product_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def factory_capabilities(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def factory_search(matchKeyword: str, keywordType: str, pageIndex: int = None, pageSize: int = None, address: str = None) -> dict:
    """
...
@mcp.tool()
def factory_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
if __name__ == "__main__":
    print("正在启动factory_insight MCP服务器...")
