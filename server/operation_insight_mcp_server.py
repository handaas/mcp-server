...
@mcp.tool()
def product_tags(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def company_trends(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def brand_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def enterprise_rankings(matchKeyword: str, keywordType: str = None, pageIndex: int = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def business_scale(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def news_sentiment_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def similar_projects(matchKeyword: str, pageIndex: int = None, pageSize: int = None, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def tax_qualifications(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def financing_info(matchKeyword: str, keywordType: str = None) -> dict:
    """
