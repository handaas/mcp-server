...
@mcp.tool()
def channel_analysis(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def channel_search(matchKeyword: str, address: str = None, keywordType: str = None, pageIndex: int = None, channelTradeType: str = None, pageSize: int = None) -> dict:
    """
