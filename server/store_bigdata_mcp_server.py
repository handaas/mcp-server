...
@mcp.tool()
def company_restaurant_branches(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def offline_store_search(ooStoreName: str = None, ooStoreBrandList: str = None, ooStoreCalClassification: str = None, address: str = None, ooStoreStatus: str = None, ooStoreAddressValue: str = None, hasMobile: str = None, hasPhone: int = None, pageSize: int = None, ooMinStorePerCapitaConsumption: float = None, ooMaxStorePerCapitaConsumption: float = None, pageIndex: int = None) -> dict:
    """
...
@mcp.tool()
def restaurant_branch_stats(matchKeyword: str, pageIndex: int = None, pageSize: int = None) -> dict:
    """
