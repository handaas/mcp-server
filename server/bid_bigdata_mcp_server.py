...
@mcp.tool()
def bid_win_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def bidding_info(matchKeyword: str, pageSize: int = None, keywordType: str = None, pageIndex: int = None) -> dict:
    """
...
@mcp.tool()
def tender_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def procurement_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def bid_search(matchKeyword: str = None, biddingType: str = None, biddingRegion: str = None, biddingAnncPubStartTime: str = None, biddingAnncPubEndTime: str = None, searchMode: str = None, biddingProjectMaxAmount: float = None, biddingPurchasingType: str = None, biddingProjectMinAmount: float = None, pageIndex: int = None, pageSize: int = None) -> dict:
    """
...
@mcp.tool()
def planned_projects(matchKeyword: str, pageIndex: int = None, pageSize: int = None, keywordType: str = None) -> dict:
    """
