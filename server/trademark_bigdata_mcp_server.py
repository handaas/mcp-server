...
@mcp.tool()
def trademark_search(matchKeyword: str, keywordType: str = None, pageIndex: int = None, pageSize: int = None, tmStatus: str = None) -> dict:
    """
...
@mcp.tool()
def trademark_profile(matchKeyword: str, keywordType: str = None) -> dict:
    """
...
@mcp.tool()
def trademark_stats(matchKeyword: str, keywordType: str = None) -> dict:
    """
